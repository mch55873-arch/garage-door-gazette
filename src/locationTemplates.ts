...
const CSS = `
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:#fff;color:#172033;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif;-webkit-font-smoothing:antialiased}a{color:inherit;text-decoration:none}.wrap{width:min(1180px,calc(100% - 32px));margin:auto}.top{background:#0d1624;color:#dbe7f5;font-size:12px}.top .wrap,.nav .wrap{display:flex;align-items:center;justify-content:space-between;gap:20px}.top .wrap{padding:9px 0}.nav{position:sticky;top:0;z-index:30;background:rgba(255,255,255,.97);backdrop-filter:blur(14px);border-bottom:1px solid #dfe6ee;box-shadow:0 10px 32px rgba(16,24,38,.08)}.nav .wrap{padding:14px 0}.brand{display:flex;align-items:center;gap:11px;font-size:20px;font-weight:950;color:#101826;letter-spacing:-.02em}.logo{width:44px;height:44px;border-radius:12px;display:grid;place-items:center;background:linear-gradient(135deg,#1476c8,#0d4f8b);color:#fff;box-shadow:0 10px 24px rgba(20,118,200,.25)}.brand small{display:block;font-size:9px;letter-spacing:.14em;text-transform:uppercase;color:#6c7a8b}.links{display:flex;gap:22px;font-size:14px;font-weight:850}.links a:hover{color:#1476c8}.btn{display:inline-flex;align-items:center;justify-content:center;min-height:48px;padding:14px 21px;border-radius:10px;background:#f47a1f;color:#fff;font-weight:900;box-shadow:0 10px 24px rgba(244,122,31,.24);transition:.2s}.btn:hover{transform:translateY(-2px);background:#dc6815}.btn.dark{background:#101826}.btn.ghost{background:transparent;border:1px solid rgba(255,255,255,.38);box-shadow:none}.hero{position:relative;overflow:hidden;background:linear-gradient(135deg,#0d1624 0%,#15324c 58%,#0b5a90 100%);color:#fff;padding:78px 0}.hero-grid{display:grid;grid-template-columns:1.05fr .95fr;gap:48px;align-items:center}.hero h1{font-size:clamp(44px,6vw,72px);line-height:1.01;letter-spacing:-.052em;margin:20px 0}.hero h1 em{font-style:normal;color:#74c8fa}.hero p{font-size:18px;line-height:1.75;color:#d6e2ee;max-width:760px}.hero-photo{position:relative}.hero-photo img{display:block;width:100%;height:470px;object-fit:cover;border-radius:25px;box-shadow:0 32px 75px rgba(0,0,0,.34);border:1px solid rgba(255,255,255,.18)}.hero-photo:after{content:"";position:absolute;right:-14px;top:-14px;width:100px;height:100px;border-top:8px solid #f47a1f;border-right:8px solid #f47a1f;border-radius:0 22px 0 0}.crumb{font-size:13px;color:#b7cad9}.crumb a{color:#8fd4ff}.eyebrow{display:inline-flex;margin-top:18px;padding:8px 12px;border-radius:999px;background:rgba(43,151,230,.14);border:1px solid rgba(114,197,255,.3);color:#9bd6ff;font-size:11px;font-weight:900;letter-spacing:.14em;text-transform:uppercase}.buttons{display:flex;flex-wrap:wrap;gap:12px;margin-top:27px}.badges{display:flex;flex-wrap:wrap;gap:10px;margin-top:22px}.badge{padding:9px 12px;border-radius:999px;background:rgba(255,255,255,.09);border:1px solid rgba(255,255,255,.18);font-size:12px;font-weight:850;color:#eaf4fb}.stats{border-bottom:1px solid #dfe6ee;background:#fff}.stats .wrap{display:grid;grid-template-columns:repeat(4,1fr)}.stat{text-align:center;padding:27px 15px;border-left:1px solid #dfe6ee}.stat:first-child{border-left:0}.stat strong{display:block;font-size:31px;color:#101826}.stat span{display:block;margin-top:5px;color:#778495;font-size:11px;font-weight:900;text-transform:uppercase;letter-spacing:.1em}.section{padding:78px 0}.soft{background:#f3f6f9}.blue{background:#edf6fc}.dark-section{background:#101826;color:#fff}.head{display:flex;align-items:end;justify-content:space-between;gap:28px;margin-bottom:32px}.eyeline{display:inline-block;color:#1476c8;font-size:11px;font-weight:900;letter-spacing:.13em;text-transform:uppercase}.section h2{font-size:clamp(34px,4vw,50px);line-height:1.08;margin:8px 0 0;letter-spacing:-.038em}.muted{max-width:760px;color:#667486;line-height:1.75}.grid{display:grid;grid-template-columns:repeat(3,1fr);gap:20px}.card{display:block;background:#fff;border:1px solid #dfe6ee;border-radius:18px;padding:25px;box-shadow:0 8px 26px rgba(16,24,38,.06);transition:.2s}.card:hover{transform:translateY(-4px);border-color:#9ccfeb;box-shadow:0 18px 40px rgba(16,24,38,.12)}.card b{display:grid;place-items:center;width:46px;height:46px;border-radius:13px;background:#eaf4fb;color:#1476c8;font-size:14px}.card h3{font-size:20px;margin:17px 0 9px;color:#101826;letter-spacing:-.02em}.card p{color:#667486;line-height:1.68;margin:0;font-size:14px}.more{display:inline-block;margin-top:17px;color:#1476c8;font-weight:900;font-size:14px}.directory{display:grid;grid-template-columns:repeat(4,1fr);gap:13px}.directory a{display:flex;align-items:center;justify-content:space-between;gap:15px;padding:17px 18px;border:1px solid #dfe6ee;border-radius:13px;background:#fff;color:#344054;font-size:14px;font-weight:850;box-shadow:0 6px 18px rgba(16,24,38,.04);transition:.18s}.directory a:after{content:"→";color:#1476c8}.directory a:hover{transform:translateY(-2px);color:#1476c8;border-color:#89c9ed}.content{display:grid;grid-template-columns:minmax(0,1fr) 340px;gap:40px}.article{font-size:17px;line-height:1.82}.article h2{font-size:30px;color:#101826;margin-top:40px;letter-spacing:-.025em}.article h3{font-size:21px;color:#101826}.article p,.article li{color:#5e6d7e}.article li{margin:8px 0}.side{position:sticky;top:105px;align-self:start;background:linear-gradient(145deg,#101826,#174c74);color:#fff;border-radius:19px;padding:27px;box-shadow:0 18px 45px rgba(16,24,38,.2)}.side p{color:#d5e2ee;line-height:1.65}.side .more{display:block;color:#9bd6ff}.notice{background:#fff7ed;border:1px solid #fed7aa;border-radius:14px;padding:19px;color:#9a3412;line-height:1.65}.process{display:grid;grid-template-columns:repeat(4,1fr);gap:18px;margin-top:34px}.step{background:#fff;border:1px solid #dfe6ee;border-radius:16px;padding:23px}.step b{font-size:35px;color:#dce7ef}.step h3{font-size:20px;color:#101826}.step p{color:#667486;line-height:1.65}.faq{display:grid;gap:12px;margin-top:28px}.faq details{background:#fff;border:1px solid #dfe6ee;border-radius:13px;padding:18px 20px}.faq summary{cursor:pointer;font-weight:900;color:#101826}.faq p{color:#667486;line-height:1.7}.footer{background:#101826;color:#aebdca;padding:54px 0 22px}.footer .wrap{display:grid;grid-template-columns:1.2fr 1fr 1fr;gap:36px}.footer h3{color:#fff}.footer a{display:block;margin:10px 0}.legal{grid-column:1/-1;border-top:1px solid rgba(255,255,255,.1);padding-top:20px;font-size:12px}.sticky{position:fixed;right:18px;bottom:18px;z-index:80}@media(max-width:920px){.links{display:none}.hero-grid,.content{grid-template-columns:1fr}.hero-photo img{height:420px}.grid{grid-template-columns:repeat(2,1fr)}.directory{grid-template-columns:repeat(2,1fr)}.process{grid-template-columns:repeat(2,1fr)}.side{position:static}.footer .wrap{grid-template-columns:1fr 1fr}}@media(max-width:620px){.top span:last-child{display:none}.hero{padding:58px 0}.hero h1{font-size:44px}.hero-photo img{height:360px}.grid,.directory,.process,.footer .wrap{grid-template-columns:1fr}.stats .wrap{grid-template-columns:1fr 1fr}.stat:nth-child(3){border-left:0;border-top:1px solid #dfe6ee}.stat:nth-child(4){border-top:1px solid #dfe6ee}.head{display:block}.btn{width:100%}.sticky{left:12px;right:12px;bottom:12px}}
`;
...
export function homePage(states: StateRow[]) {
  ...
  const body = `<main><section class="hero"><div class="wrap hero-grid"><div><span class="eyebrow">Nationwide garage door directory</span><h1>Find reliable garage door repair <em>in your city</em></h1><p>Research garage door issues, explore ${services.length} specialized service topics and connect with independent service providers across all 50 states.</p><div class="buttons"><a class="btn" href="#states">Browse All States</a><a class="btn ghost" href="#services">View ${services.length} Services</a></div><div class="badges"><span class="badge">Independent providers</span><span class="badge">City-specific routes</span><span class="badge">24/7 Hotline support</span></div></div><div class="hero-photo"><img src="${IMAGES.hero}" alt="Modern garage door" width="800" height="620"></div></div></section><section class="stats"><div class="wrap"><div class="stat"><strong>51</strong><span>States & DC</span></div><div class="stat"><strong>${services.length}</strong><span>Service topics</span></div><div class="stat"><strong>City</strong><span>Local Subdomains</span></div><div class="stat"><strong>Direct</strong><span>Availability Check</span></div></div></section><section class="section soft" id="states"><div class="wrap"><div class="head"><div><span class="eyeline">Areas We Serve</span><h2>Garage door service directory by state</h2><p class="muted">Select your state to explore local cities and communities.</p></div></div><div class="directory">${stateLinks}</div></div></section><section class="section" id="services"><div class="wrap"><div class="head"><div><span class="eyeline">Services Directory</span><h2>All ${services.length} garage door services</h2><p class="muted">Review repair, opener, spring, cable, track, panel, weatherproofing, installation, maintenance and commercial topics.</p></div></div><div class="grid">${serviceCards(DOMAIN, false)}</div></div></section></main>`;
...
export function servicesHubPage() {
  ...
  const body = `<main><section class="hero"><div class="wrap hero-grid"><div><div class="crumb"><a href="https://${DOMAIN}/">Home</a> / Services</div><span class="eyebrow">National Service Hub</span><h1>Garage door repair & installation <em>services</em></h1><p>Browse our complete catalog of ${services.length} garage door repair, opener installation, spring replacement, track alignment, cable repair, and commercial overhead door services.</p><div class="buttons"><a class="btn" href="tel:${PHONE}">Call ${PHONE}</a></div></div><div class="hero-photo"><img src="${IMAGES.service}" alt="Garage door service" width="800" height="620"></div></div></section><section class="section"><div class="wrap"><div class="head"><div><span class="eyeline">Complete Directory</span><h2>All ${services.length} Service Topics</h2></div></div><div class="grid">${serviceCards(DOMAIN, false)}</div></div></section></main>`;
  return shell("All Garage Door Services Directory", `Browse all ${services.length} garage door repair and installation services across the United States.`, canonical, body, schema);
}
...
export function nationalServicePage(service: (typeof services)[number]) {
  ...
  const body = `<main><section class="hero"><div class="wrap hero-grid"><div><div class="crumb"><a href="https://${DOMAIN}/">Home</a> / <a href="https://${DOMAIN}/services/">Services</a> / ${esc(service.title)}</div><span class="eyebrow">${esc(service.category)}</span><h1>${esc(service.title)} <em>Guide & Service Directory</em></h1><p>${esc(service.summary)} Review warning signs, inspection considerations, and independent provider options.</p><div class="buttons"><a class="btn" href="tel:${PHONE}">Call ${PHONE}</a><a class="btn ghost" href="https://${DOMAIN}/areas-we-serve/">Find Local Provider</a></div></div><div class="hero-photo"><img src="${IMAGES.service}" alt="${esc(service.title)}" width="800" height="620"></div></div></section><section class="section content"><div class="wrap article"><span class="eyeline">Service Overview</span><h2>About ${esc(service.title)}</h2><p>${esc(service.summary)} Start with a thorough diagnosis before authorizing repair or component replacement.</p><h2>Related Services</h2><div class="grid" style="margin-top:20px">${related.map((item) => `<a class="card" href="https://${DOMAIN}/services/${item.slug}/"><h3>${esc(item.title)}</h3><p>${esc(item.summary)}</p><span class="more">Learn more →</span></a>`).join("")}</div></div></section></main>`;
...
export function areasWeServePage(states: StateRow[]) {
  ...
  const body = `<main><section class="hero"><div class="wrap hero-grid"><div><div class="crumb"><a href="https://${DOMAIN}/">Home</a> / Areas We Serve</div><span class="eyebrow">Location Directory</span><h1>Garage door services by <em>State & City</em></h1><p>Select your state below to explore city subdomains and local independent garage door service providers.</p><div class="buttons"><a class="btn" href="#states">Browse States</a></div></div><div class="hero-photo"><img src="${IMAGES.state}" alt="Areas we serve" width="800" height="620"></div></div></section><section class="section soft" id="states"><div class="wrap"><div class="directory">${stateLinks}</div></div></section></main>`;
  return shell("Areas We Serve - State & City Garage Door Directory", "Browse garage door service locations across all 50 US states and thousands of local cities.", canonical, body, schema);
}

export function articlesHubPage() {
  const canonical = `https://${DOMAIN}/articles/`;
  const articleCards = articles.map((article) => `<a class="card" href="https://${DOMAIN}/articles/${article.slug}/"><h3>${esc(article.title)}</h3><p>${esc(article.summary)}</p><span class="more">Read guide →</span></a>`).join("");
  const schema = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "CollectionPage",
        name: "Garage Door Guides & Knowledge Articles",
        url: canonical
      },
      {
        "@type": "BreadcrumbList",
  ...
  const body = `<main><section class="hero"><div class="wrap hero-grid"><div><div class="crumb"><a href="https://${DOMAIN}/">Home</a> / Articles</div><span class="eyebrow">Garage Door Guides</span><h1>Expert garage door <em>articles & advice</em></h1><p>Learn how to diagnose garage door problems, understand spring safety, choose openers, and maintain your system.</p></div><div class="hero-photo"><img src="${IMAGES.service}" alt="Garage door articles" width="800" height="620"></div></div></section><section class="section"><div class="wrap"><div class="grid">${articleCards}</div></div></section></main>`;
  return shell("Garage Door Articles & Repair Guides", "Browse technical guides, troubleshooting advice, and safety information for residential and commercial garage doors.", canonical, body, schema);
}
...
export function articlePage(article: (typeof articles)[number]) {
  ...
  const body = `<main><section class="hero"><div class="wrap hero-grid"><div><div class="crumb"><a href="https://${DOMAIN}/">Home</a> / <a href="https://${DOMAIN}/articles/">Articles</a> / ${esc(article.title)}</div><span class="eyebrow">Garage Guide</span><h1>${esc(article.title)}</h1><p>${esc(article.summary)}</p></div><div class="hero-photo"><img src="${IMAGES.service}" alt="${esc(article.title)}" width="800" height="620"></div></div></section><section class="section content"><div class="wrap article"><p>${esc(article.summary)}</p><p>For complex mechanical, spring, or electrical problems, always consult a qualified independent provider before attempting repairs.</p></div></section></main>`;
  return shell(`${article.title} | Garage Door Gazette`, article.summary, canonical, body, schema);
}
